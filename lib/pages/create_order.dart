...
class _CreateOrderScreenState extends State<CreateOrderScreen> {
  ...
  void _initializeEditOrder() {
    ...
    // }
    // productDateRanges = widget.order!.datesInUse!;
...
// widget.order!.datesInUse
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        _calculateTotalPrice();
        dataBaseProvider.selectedProductsNotifier.notifyListeners();
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    print("${dataBaseProvider.selectedProductsNotifier.value} DESDET");
                                                        ...
                                                        final alquilerTotal =
                                                            totalOwned -
                                                                selectedProducts
                                                                  ...
                                                                  if (endDays[product
                                                                      ...
                                                                      startDays[
                                                                          ...
                                                                          null) {
                                                                    totalDays =
                                                                        endDays[product.id]!.difference(startDays[product.id]!).inDays +
                                                                            1;
                                                                  }
                                                                  print(
                                                                      'totalDays: $totalDays -TESTOY');
                                                                  ...
                                                                  final quantity =
                                                                      product.quantity
                                                                          ...
                                                                          0;
                                                                  print(
                                                                      'quantity: $quantity -TESTOY');

                                                                  var totalCost = product
                                                                          .cost *
                                                                      quantity *
                                                                      totalDays;
                                                                  print(
                                                                      'totalCost: $totalCost -TESTOY');
                                                                ...
                                                                dataBaseProvider
                                                                  ...
                                                                  print(
                                                                      'updatedPreviousValue: $updatedPreviousValue -TESTOY');
                                                                  return updatedPreviousValue;
                                                                });
                                                        print(
                                                            'alquilerTotal: $alquilerTotal -TESTOY');
  ...
  void showCalendar(
    ...
    print("${startDays[product.id]} fastk");
